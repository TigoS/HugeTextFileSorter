...
{
    /// <summary>
    /// Provides methods for generating test files containing random or partially duplicated alphanumeric data for use
    /// in testing and benchmarking scenarios.
    /// </summary>
    /// <remarks>This class is static and cannot be instantiated. It is designed to facilitate the creation of
    /// large files with customizable content patterns, such as varying word counts, word lengths, and duplicate string
    /// densities. All members are thread-safe for concurrent use.</remarks>
    public static class RandomFileGenerator
    {
        ...
        /// <summary>
        /// Generates a text file containing random or duplicate lines according to the specified parameters and returns
        /// the number of lines written.
        /// </summary>
        /// <remarks>If the operation is cancelled via the cancellation token, an
        /// OperationCanceledException is thrown. The method attempts to match the requested file size as closely as
        /// possible, but the actual size may differ slightly due to line length variations. The generated file will be
        ...
        /// <param name="fileSize">The desired size of the generated file, in bytes. The method attempts to create a file as close as possible
        /// to this size.</param>
        ...
        /// <param name="duplicateStringDensity">The percentage (0–100) of lines that should be duplicates. A value of 0 means all lines are unique; 100
        /// means all lines are duplicates. Defaults to 0.</param>
        ...
        /// <summary>
        /// Estimates the maximum number of bytes required to represent a single line, based on the specified parameters
        /// and size estimation type.
        /// </summary>
        /// <remarks>The estimation assumes UTF-8 encoding and accounts for the number portion, word
        /// count, word length, and necessary spacing. The returned value is suitable for buffer allocation or sizing
        /// scenarios where an upper bound or typical size is needed.</remarks>
        /// <param name="maxNumber">The largest number that may appear at the start of the line. Determines the maximum digit count for the
        /// number portion.</param>
        ...
        /// <param name="estimatedSizeType">The type of size estimation to use. Specifies whether to estimate the minimum, average, or maximum possible
        /// line size.</param>
        /// <returns>The estimated size, in bytes, required to represent a line with the given constraints. The value depends on
        /// the specified estimation type.</returns>
        ...
        /// </summary>
        /// <param name="duplicateStringDensity">The threshold value, as a percentage from 1 to 100, representing the likelihood that a value is treated as a
        /// duplicate. Must be greater than 0.</param>
        ...
        /// <summary>
        /// Formats a line using a random number, a delimiter, and the specified duplicate string according to the
        /// alphanumeric entity pattern.
        /// </summary>
        ...
        /// <returns>A string formatted with a random number, a delimiter, and the specified duplicate string, following the
        /// alphanumeric entity line pattern.</returns>
        ...
        /// <summary>
        /// Generates a random integer that is greater than or equal to a predefined minimum and less than the specified
        /// maximum value.
        /// </summary>
        /// <param name="maxNumber">The exclusive upper bound for the random number to generate. Must be greater than the predefined minimum
        /// value.</param>
        /// <returns>A random integer greater than or equal to the predefined minimum value and less than <paramref
        /// name="maxNumber"/>.</returns>
        ...
        /// <returns>A randomly generated string containing up to the specified number of words, with each word containing up to
        /// the specified number of characters. The first character of the string is capitalized.</returns>
