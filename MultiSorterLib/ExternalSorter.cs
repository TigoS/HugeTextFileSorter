namespace MultiSorterLib
{
    ...
    /// memory.
    /// </summary>
    /// <remarks>The ExternalSorter class is designed for scenarios where input files are too large to be sorted in memory. It splits the input file into manageable, sorted chunks that can later be merged to produce a fully sorted file. All members of this class are static and thread-safe for independent operations.</remarks>
    public static class ExternalSorter
    {
        ...
        /// </summary>
        /// <remarks>This constant is typically used to convert values to kilobytes when determining buffer or chunk sizes.</remarks>
        const long CHUNK_SIZE_MULTIPLIER = 1024L;

        /// <summary>
        /// Splits a large input file into multiple sorted temporary chunk files.
        /// </summary>
        /// <remarks>Each temporary file contains a sorted subset of lines from the input file, using ordinal string comparison. The caller is responsible for deleting the temporary files after use. This method is useful for external sorting of large files that do not fit into memory.</remarks>
        ...
        /// <returns>A list of file paths to the temporary files, each containing a sorted chunk of the original input. The list will be empty if the input file contains no non-empty lines.</returns>
