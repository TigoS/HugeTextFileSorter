namespace MultiSorterLib
{
    ...
    /// </summary>
    /// <remarks>This class includes methods to represent file sizes in human-readable formats (such as KB, MB, GB) and to convert between formatted sizes and their byte values. The metric prefixes used follow the standard binary multiples (e.g., Kilo for 1024, Mega for 1024^2). These methods are intended to simplify displaying and working with file sizes in applications that require user-friendly representations.</remarks>
    public static class FileSizeExtensions
    {
        ...
        /// data contexts to indicate multiples of a base unit. For example, 'Kilo' represents 10^3 (1,000), 'Mega' represents 10^6 (1,000,000), and so on up to 'Yotta' for 10^24. Use this enumeration to clearly indicate the scale of a measurement or quantity when working with metric units.</remarks>
        ...
        /// <summary>
        /// Specifies the type of estimated size to use when calculating or reporting values that can vary, such as minimum, average, or maximum sizes.
        /// </summary>
        /// <remarks>Use this enumeration to indicate whether a minimum, average, or maximum estimated size should be considered in operations that support size estimation. The values correspond to common estimation strategies and may affect the results returned by methods or properties that utilize this type.</remarks>
        ...
        /// </summary>
        /// <remarks>This method uses binary (base-1024) prefixes (e.g., KB = 1024 bytes). The formatted string includes up to two decimal places. If fileSize is less than 1024, the value is shown in bytes.
        /// If metricBenchmark is set to a value other than None, formatting begins at that prefix level.</remarks>
        ...
        /// <returns>A string representing the formatted file size with the appropriate metric prefix. If showBytes is true and a metric prefix is used, the exact byte count is included in parentheses.</returns>
        ...
        /// </summary>
        /// <remarks>This method is useful for converting file sizes specified in larger units (such as kilobytes or megabytes) to their byte representation. The calculation uses binary multipliers (powers of 1024) based on the specified metric prefix.</remarks>
        ...
        /// </summary>
        /// <remarks>Use this method to obtain a file size in units such as kilobytes, megabytes, or gigabytes, based on the metric prefix provided. The conversion uses binary multiples (e.g., 1024 for kilobyte).</remarks>
        /// <param name="fileSize">The file size in bytes to convert.</param>
        /// <param name="metricBenchmark">The metric unit to which the file size should be converted. Specify a value from the <see cref="MetricPrefixes"/> enumeration. If <see cref="MetricPrefixes.None"/> is provided, the result is in bytes.</param>
